...
internal fun View.slideUp() {
    ...
    val translateAnimation = TranslateAnimation(0f, 0f, this.measuredHeight.toFloat(), 0f).apply {
        duration = 250
    }
...
internal fun View.slideDown() {
    ...
    val translateAnimation = TranslateAnimation(0f, 0f, 0f, this.height.toFloat()).apply {
        duration = 200
    }

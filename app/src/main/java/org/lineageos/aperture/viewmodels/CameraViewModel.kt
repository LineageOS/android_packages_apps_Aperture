...
class CameraViewModel(application: Application) : AndroidViewModel(application) {
     ...
     * Video quality.
     */
    val videoQuality = MutableStateFlow<Quality>(Quality.FHD)

    /**
     * Video frame rate.
     */
    val videoFrameRate = MutableStateFlow<FrameRate?>(null)

    /**
     * Video dynamic range.
     */
    val videoDynamicRange = MutableStateFlow(VideoDynamicRange.SDR)

    /**
     * Video mic mode.
     */
    val videoMicMode = MutableStateFlow(false)

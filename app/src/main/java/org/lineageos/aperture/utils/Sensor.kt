...
import org.lineageos.aperture.reverse
    ...
    private val horizontalLength: Float
        get() {
            ...
            if (is90or270((orientation))) {
                sensorSize = sensorSize.reverse()
                activeArraySize = activeArraySize.reverse()
                pixelArraySize = pixelArraySize.reverse()
            }
    ...
    companion object {
        ...
        private fun focalLengthToViewAngleDegrees(focalLength: Float, sensorLength: Float): Int {
            ...
            assert(viewAngleDegrees in 0..360) {
                "The provided focal length and sensor length result in an invalid view angle degrees."
            }
        ...
        private fun is90or270(rotationDegrees: Int): Boolean {
            ...
            throw java.lang.IllegalArgumentException("Invalid rotation degrees: $rotationDegrees")
        }
    }
}

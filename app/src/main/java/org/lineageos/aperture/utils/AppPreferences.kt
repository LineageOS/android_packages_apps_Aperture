...
import org.lineageos.aperture.edit

class AppPreferences(val context: Context) {
    private val sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context)

    private fun edit(commit: Boolean = false, action: SharedPreferences.Editor.() -> Unit) =
    ...
    internal var lastCameraMode: CameraMode
    ...
    val imageStabilizationMode: StabilizationMode
    ...
    val videoStabilizationMode: StabilizationMode
        get() {

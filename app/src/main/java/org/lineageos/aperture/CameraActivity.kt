...
open class CameraActivity : AppCompatActivity(R.layout.activity_camera) {
    ...
    private var camera by viewModel.camera::value
    private var cameraMode by viewModel.cameraMode::value
    private var singleCaptureMode by viewModel.inSingleCaptureMode::value
    private var cameraState by viewModel.cameraState::value
    private var flashMode by viewModel.flashMode::value
    private val timerMode by viewModel.timerMode::value
    private var photoCaptureMode by viewModel.photoCaptureMode::value
    private val photoAspectRatio by viewModel.photoAspectRatio::value
    private var photoEffect by viewModel.photoEffect::value
    private var videoQuality by viewModel.videoQuality::value
    private var videoFrameRate by viewModel.videoFrameRate::value
    private var videoDynamicRange by viewModel.videoDynamicRange::value
    private var videoMicMode by viewModel.videoMicMode::value
    private var videoRecording by viewModel.videoRecording::value
    private var videoDuration by viewModel.videoRecordingDuration::value
    ...
    private fun cycleFlashMode(forceTorch: Boolean): Boolean {
        ...
        val forceTorchAvailable = cameraMode == CameraMode.PHOTO
                && camera?.supportedFlashModes.orEmpty().contains(FlashMode.TORCH)

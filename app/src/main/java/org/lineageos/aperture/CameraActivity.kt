...
open class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lensSelectorLayout.cameraViewModel = cameraViewModel
        ...
        // Observe camera
        cameraViewModel.camera.observe(this) {
        ...
        cameraViewModel.screenRotation.observe(this) { rotateViews(it) }

        // Observe flash mode
        cameraViewModel.flashMode.observe(this) {
        ...
        // Observe grid mode
        cameraViewModel.gridMode.observe(this) {
        ...
        // Observe timer mode
        cameraViewModel.timerMode.observe(this) {
        ...
        cameraViewModel.photoCaptureMode.observe(this) {
            // Update secondary bar buttons
            updateSecondaryBarButtons()
        }

        // Observe photo aspect ratio
        cameraViewModel.photoAspectRatio.observe(this) {
        ...
        cameraViewModel.photoEffect.observe(this) {
        ...
        cameraViewModel.videoQuality.observe(this) {
        ...
        cameraViewModel.videoFrameRate.observe(this) {
        ...
        cameraViewModel.videoMicMode.observe(this) {
        ...
        cameraViewModel.videoAudioConfig.observe(this) {
            // Update secondary bar buttons
            updateSecondaryBarButtons()
        }
    ...
    private fun updateSecondaryBarButtons() {
        runOnUiThread {
            val camera = cameraViewModel.camera.value ?: return@runOnUiThread
            ...
            val photoCaptureMode = cameraViewModel.photoCaptureMode.value ?: return@runOnUiThread
            val videoQuality = cameraViewModel.videoQuality.value ?: return@runOnUiThread
            val videoAudioConfig = cameraViewModel.videoAudioConfig.value ?: return@runOnUiThread

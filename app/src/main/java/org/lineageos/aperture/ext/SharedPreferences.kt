...
internal fun SharedPreferences.edgeMode(default: String) =
    when (getString(EDGE_MODE_KEY, default)) {
        "default" -> null
        "off" -> EdgeMode.OFF
        "fast" -> EdgeMode.FAST
...
internal fun SharedPreferences.noiseReductionMode(default: String) =
    when (getString(NOISE_REDUCTION_MODE_KEY, default)) {
        "default" -> null
...
internal fun SharedPreferences.shadingMode(default: String) =
    when (getString(SHADING_MODE_KEY, default)) {
        "default" -> null
        "off" -> ShadingMode.OFF
...
internal fun SharedPreferences.colorCorrectionAberrationMode(default: String) =
    when (getString(COLOR_CORRECTION_ABERRATION_MODE_KEY, default)) {
        "default" -> null
...
internal fun SharedPreferences.distortionCorrectionMode(default: String) =
    when (getString(DISTORTION_CORRECTION_MODE_KEY, default)) {
        "default" -> null
...
internal fun SharedPreferences.hotPixelMode(default: String) =
    when (getString(HOT_PIXEL_MODE_KEY, default)) {
        "default" -> null

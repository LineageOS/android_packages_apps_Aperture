...
internal fun SharedPreferences.edgeMode(resources: Resources): EdgeMode? {
...
internal fun SharedPreferences.noiseReductionMode(resources: Resources): NoiseReductionMode? {
    return when (getString(
...
internal fun SharedPreferences.shadingMode(resources: Resources): ShadingMode? {
    return when (getString(
        SHADING_MODE_KEY,
...
internal fun SharedPreferences.colorCorrectionAberrationMode(resources: Resources): ColorCorrectionAberrationMode? {
    return when (getString(
...
internal fun SharedPreferences.distortionCorrectionMode(resources: Resources): DistortionCorrectionMode? {
    return when (getString(
...
internal fun SharedPreferences.hotPixelMode(resources: Resources): HotPixelMode? {
    return when (getString(
        HOT_PIXEL_MODE_KEY,

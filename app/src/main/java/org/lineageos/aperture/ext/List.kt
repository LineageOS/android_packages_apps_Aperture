 ...
 *
 * If the element is the last in the list or it's not present in the list it will return the first
 * element. If the list is empty, null will be returned.
 *
 ...
 *
 * If the element is the first in the list or it's not present in the list it will return the last
 * element. If the list is empty, null will be returned.
 *
 * @param current The element to use as cursor

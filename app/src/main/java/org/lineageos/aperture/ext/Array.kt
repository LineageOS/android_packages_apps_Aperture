 ...
 *
 * If the element is the last in the array or it's not present in the array it will return the first
 * element. If the array is empty, null will be returned.
 *
 ...
 *
 * If the element is the first in the array or it's not present in the array it will return the last
 * element. If the array is empty, null will be returned.
 *
 * @param current The element to use as cursor

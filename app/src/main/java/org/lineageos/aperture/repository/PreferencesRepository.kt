...
class PreferencesRepository(
    ...
    val lastCameraFacing = Preference.EnumPreference(
        sharedPreferences = sharedPreferences,
        key = LAST_CAMERA_FACING_KEY,
        defaultValue = CameraFacing.BACK,
        enumToValue = Preference.EnumPreference.EnumToValue.invoke {
            when (this) {
    ...
    var SharedPreferences.lastCameraFacing: CameraFacing
    ...
    var SharedPreferences.lastCameraMode: CameraMode
    ...
    var SharedPreferences.lastGridMode: GridMode
    ...
    var SharedPreferences.lastMicMode: Boolean
    ...
    val SharedPreferences.photoCaptureMode: Int
    ...
    var SharedPreferences.photoFfcMirror: Boolean
        get() = getBoolean(PHOTO_FFC_MIRROR, PHOTO_FFC_MIRROR_DEFAULT)
        set(value) = edit {
            putBoolean(PHOTO_FFC_MIRROR, value)
        }

    const val PHOTO_FLASH_MODE_KEY = "photo_flash_mode"
    private const val PHOTO_FLASH_MODE_DEFAULT = "auto"

    var SharedPreferences.photoFlashMode: FlashMode
    ...
    const val VIDEO_FLASH_MODE_KEY = "video_flash_mode"
    private const val VIDEO_FLASH_MODE_DEFAULT = "off"

    var SharedPreferences.videoFlashMode: FlashMode
    ...
    var SharedPreferences.photoEffect: Int
    ...
    var SharedPreferences.videoFrameRate: FrameRate?
    ...
    var SharedPreferences.videoQuality: Quality
    ...
    var SharedPreferences.timerMode: TimerMode
    ...
    var SharedPreferences.aspectRatio: Int
    ...
    var SharedPreferences.brightScreen: Boolean
    ...
    var SharedPreferences.saveLocation: Boolean?
    ...
    var SharedPreferences.shutterSound: Boolean
    ...
    var SharedPreferences.leveler: Boolean
    ...
    val SharedPreferences.videoStabilization: Boolean
    ...
    val SharedPreferences.edgeMode: EdgeMode?
    ...
    val SharedPreferences.noiseReductionMode: NoiseReductionMode?
    ...
    val SharedPreferences.shadingMode: ShadingMode?
    ...
    val SharedPreferences.colorCorrectionAberrationMode: ColorCorrectionAberrationMode?
        get() = when (getString(
    ...
    val SharedPreferences.distortionCorrectionMode: DistortionCorrectionMode?
    ...
    val SharedPreferences.hotPixelMode: HotPixelMode?
    ...
    var SharedPreferences.forceTorchHelpShown: Boolean
    ...
    var SharedPreferences.videoDynamicRange: VideoDynamicRange
    ...
    val SharedPreferences.videoMirrorMode: VideoMirrorMode
    ...
    companion object {
        ...
        fun SharedPreferences.Editor.putBoolean(key: String, value: Boolean?) {
            if (value == null) {
                remove(key)
            } else {
        ...
        private fun GestureAction.toPreferenceValue() = when (this) {
        ...
        fun stringToGestureAction(string: String?) = when (string) {

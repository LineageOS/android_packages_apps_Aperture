...
class InfoChipView @JvmOverloads constructor(
    ...
    fun setVideoMicMode(videoMicMode: Boolean) {
        this.videoMicMode = videoMicMode

        update()
    }

    fun setBatteryIntent(batteryIntent: Intent?) {
    ...
    private fun update() {
        val cameraMode = this.cameraMode ?: return

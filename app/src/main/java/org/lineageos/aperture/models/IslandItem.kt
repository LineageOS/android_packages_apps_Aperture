...
sealed interface IslandItem : UniqueItem<IslandItem> {
     ...
     */
    data class ThermalThrottling(val isCritical: Boolean) : IslandItem
     ...
     */
    data class LowBattery(val isCharging: Boolean) : IslandItem
     ...
     */
    data class PhotoRawEnabled(val withJpeg: Boolean) : IslandItem

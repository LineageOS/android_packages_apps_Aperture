...
private fun Resources.getRroIdentifier(context: Context, id: Int): Int {
...
internal fun Resources.getBoolean(context: Context, id: Int): Boolean {
    runCatching {
        return getRroResources(context).getBoolean(getRroIdentifier(context, id))
    }
...
internal fun Resources.getStringArray(context: Context, id: Int): Array<String> {
    runCatching {
        return getRroResources(context).getStringArray(getRroIdentifier(context, id))
    }
